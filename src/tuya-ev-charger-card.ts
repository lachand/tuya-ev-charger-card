...
class TuyaEvChargerCard extends LitElement {
  ...
  private _injectFonts(): void {
    ...
    link.rel = "stylesheet";
    link.href =
      "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;600;700;900&family=Inter:wght@400;500;600;700&family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap";
  ...
  private _renderDashboard() {
    ...
    const isWorking =
      chargeOn || workState.toUpperCase() === "WORKING";
